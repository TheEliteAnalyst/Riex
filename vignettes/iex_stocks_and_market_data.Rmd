...
Additional details about usage calculations available in [Data Weight - section](https://iexcloud.io/docs/api/#authentication) as well as best practice about storing and sharing [Private & Public Secret Key](https://iexcloud.io/docs/api/#authentication)
